node {
    ...
    stage('Publish  Helm') {
        ...
        echo "Packing helm chart"
            ...
            sh "mv ${WORKSPACE}/radar/radar-driver-1.tgz ${WORKSPACE}/radar/radar-driver-2.tgz"
           // sh "${WORKSPACE}/build.sh --pack_helm --push_helm --helm_repo ${HELM_REPO} --helm_usr ${HELM_USR} --helm_psw ${HELM_PSW}"
           sh "curl -u admin:ubnt@117 http://34.125.28.169:8081/repository/radar-helm/ --upload-file ${WORKSPACE}/radar/radar-driver-2.tgz -v"
